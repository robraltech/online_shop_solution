        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{asset('front-asset/images/carousel-1.jpg')}}" />
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{asset('front-asset/images/cat-1.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Mens</h2>
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{asset('front-asset/images/product-1.jpg')}}" alt=""></a>
...
<script src="{{asset('front-asse/js/bootstrap.bundle.5.1.3.min.js')}}"></script>
