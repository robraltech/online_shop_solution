          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" readonly name="slug" id="slug" class="form-control" placeholder="Slug" value="{{$subCategories->slug}}">
                <p></p>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="mb-3">
                ...
                <select name="status" id="status" class="form-control">
                  <option {{($subCategories->status == $category->id) ? 'selected':''}} value="1">Active</option>
                  <option {{($subCategories->status == $category->id) ? 'selected':''}} value="0">Inactive</option>
                </select>
                <p></p>
              </div>
            </div>
