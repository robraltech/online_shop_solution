	...
	<div class="container-fluid my-2">
		<div class="row mb-2">
			...
			<div class="col-sm-6 text-right">
				<a href="{{ route('sub-category.create') }}" class="btn btn-primary">New Category</a>
			</div>
		</div>
	</div>
</section>
			...
			<form action="#" method="GET">
				<div class="card-header">
					<div class="card-title">
						<button type="button" onclick="window.location.href='{{ route('sub-category.index') }}'" class="btn btn-default btn-sm">
							Reset
						</button>
					</div>
